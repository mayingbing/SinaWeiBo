...
@interface SZTabBarButton ()

@property (nonatomic, weak) SZBadgeView *badgeView;
...
- (SZBadgeView *)badgeView
{
    if (_badgeView == nil) {
        SZBadgeView *btn = [SZBadgeView buttonWithType:UIButtonTypeCustom];
...
- (void)layoutSubviews
{
    ...
    // 3.badgeView
    self.badgeView.x= self.bounds.size.width - self.badgeView.width - 10;
    self.badgeView.y = 0;
}
